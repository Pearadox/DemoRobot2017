...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		double throttle = -JS.getRawAxis(1)*0.6;
		double twist = JS.getRawAxis(2)*0.7;
		double strafe = JS.getRawAxis(0);
		strafe = 0;
		boolean traction = JS.getRawButton(1);
		boolean lower = JS.getRawButton(7);
		boolean raise = JS.getRawButton(8);
